...
type NoBarChartStatisticsProps = {
  refresh:() => void
}

const NoBarChartStatistics = ({refresh}: NoBarChartStatisticsProps) => {
  return (
    <div className="flex flex-col justify-center gap-5 mt-16 items-center p-3 h-96">
...
export default NoBarChartStatistics